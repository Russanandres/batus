...
echo Версия скрипта: %ver%
echo.
echo Внимание! Обноружен сбой скрипта вызванный чем либо. Попробуйте перезагрузить скрипт или обратитесь к @Russanandres в телеграмме.
echo.
ver
echo.
timeout /t -1
