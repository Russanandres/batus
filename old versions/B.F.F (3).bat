...
cls
if exist cmd.exe (title Bat For Fun %ver%) ELSE Goto :crash
...
echo [dark] Тёмная тема
set /p Ch=
if '%Ch%'=='x' goto :start
if '%Ch%'=='Debug' goto Debug
if '%Ch%'=='color' goto :color
if '%Ch%'=='light' color f0 & goto start
if '%Ch%'=='dark' color 0f & goto start
:color
cls
echo [x] Назад
...
echo. Что ищем?
echo.
echo  PS если пишите с пробелами - пишите в ковычках "при мер"
echo.
set ch=
set /p ch=))
...
echo X@@@J     .S@@@@F             .B@B@Xr:iirr7.          .B@B@G7:iilrrv  
...
echo Версия скрипта: %ver%
echo.
echo Внимание! Обноружен сбой скрипта вызванный чем либо. Попробуйте перезагрузить скрипт или обратитесь к https://t.me/Russanandres
echo.
ver
echo.
timeout /t -1
...
if %a%==42 set ST=Что ты сказал о моей маме?!
