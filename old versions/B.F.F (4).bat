...
cls
if exist cmd.exe (cd ../../.. & title Bat For Fun %ver%) ELSE set crash=cmd.exe& Goto :crash
...
cls
title Hello and welcome to the Black Mesa trance assistans!
ping localhost -n 1 >nul
title Hello and welcome to the B.F.F!
...
if %a%==46 set ST=Я хочу Борщ! А, он сам это написал.
