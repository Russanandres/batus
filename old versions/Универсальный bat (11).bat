...
if '%choice%'=='title_screen' goto :Title
...
if exist C:\Users (
    set userfolder=Users
    set uservar=%Username%
)
echo                                                                    ░                     
echo ▓   ▓                                                           ░█▒█░
echo ██ ▒█                                                            ▓█▒ 
...
if %a%==11 set splashtext=1 доллар по 75 рублей!
...
if %a%==19 set splashtext=КОСМОООООС!
