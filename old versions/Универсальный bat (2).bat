...
ver|find "6.3" >nul
if '%errorlevel%'=='0' set windowsversion= 8.1
ver|find "10" >nul
if '%errorlevel%'=='0' set windowsversion= 10
set ver=2.7.6
...
if '%choice%'=='8' cd %SYSTEMROOT%\system32&perfmon.exe&goto start
if '%choice%'=='9' cd %SYSTEMROOT%\system32&winver.exe&goto start
if '%choice%'=='10' cd %SYSTEMROOT%\system32&calc.exe&goto start
:choice1
cls
