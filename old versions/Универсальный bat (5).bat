@echo off
ver|find "5.0" >nul
if '%errorlevel%'=='0' set windowsversion=Windows 2000&title Режим совместимости с WinNT&msg * В Windows 2000 некоторые функции не поддерживаются.
ver|find "5.1" >nul
...
if '%choice%'=='6' cd %SYSTEMROOT%\system32&dxdiag.exee&goto run
