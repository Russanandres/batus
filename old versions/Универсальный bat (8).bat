...
if %a%==45 set splashtext=MADE IN SAINT-PETERBURG
if %a%==46 set splashtext=Hello, %user%!
if %a%==47 set splashtext=Arr!
if %a%==48 set splashtext=Ifcolors turns on colors if set to 1!
if %a%==49 set splashtext=Game update 1.5!
if %a%==50 set splashtext=Now more stable!
if %a%==51 set splashtext=Now with Compatibillity desktop!
if %a%==52 set splashtext=Compatibillity update 1.6!
if %a%==53 set splashtext=Dave's not here, man!
if %a%==54 set splashtext=No DEBUG, no color or mouse!
if %a%==55 set splashtext=64 bit machines are a pain!
if %a%==56 set splashtext=Continuation update 1.6!